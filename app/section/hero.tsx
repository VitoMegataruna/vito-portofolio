...
export default function Hero() {
  ...
  useEffect(() => {
    // aktifkan animasi setelah komponen mount
    setIsVisible(true);
  }, []);
    ...
    <div className="w-full h-screen">
      <div className="relative md:flex md:flex-cols-2 grid-flow-row h-[75%] w-full">
        <div className="w-full md:h-full h-[100%] bg-primary border-4 border-t-4 border-index flex flex-col gap-5 md:justify-center">
          <div
            className={`md:text-6xl text-5xl font-extrabold flex flex-col ml-8 md:-mt-5 md:w-1/2 mt-6 transition-transform duration-700 ease-out
